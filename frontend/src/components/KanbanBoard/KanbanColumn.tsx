...
export function KanbanColumn({ title, dotColor, tasks, comments, onOpenTask }: KanbanColumnProps) {
  return (
    <section className="flex flex-col min-w-[280px] flex-1 border-r border-[var(--app-border)] last:border-r-0">
      <div className="flex items-center gap-2.5 border-b border-[var(--app-border)] px-4 py-3 shrink-0">
      ...
      <div className="flex-1 flex flex-col gap-3 overflow-y-auto px-3 py-3 custom-scrollbar">
        {tasks.length === 0 ? (
